...
namespace Lib.Services
{
    ...
    public partial class LoginFailLogs
    {
        ...
        {
            LoginFailLogInfo loginFailLogInfo = Lib.Data.LoginFailLogs.GetLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        ...
        {
            Lib.Data.LoginFailLogs.AddLoginFailTimes(CommonHelper.ConvertIPToLong(loginIP), loginTime);
        }
        ...
        {
            Lib.Data.LoginFailLogs.DeleteLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        }
    }
}
