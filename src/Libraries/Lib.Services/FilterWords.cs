...
namespace Lib.Services
{
    ...
    public partial class FilterWords
    {
        ...
        static FilterWords()
        {
            string[] wordList = StringHelper.SplitString(MngConfig.SiteConfig.IgnoreWords, "\n");
        ...
        {
            return Lib.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = Lib.Core.MngCache.Get(CacheKeys.SITE_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                Lib.Core.MngCache.Insert(CacheKeys.SITE_FILTERWORD_REGEXLIST, filterWordRegexList);
            }
