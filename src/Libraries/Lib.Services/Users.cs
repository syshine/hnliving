...
namespace Lib.Services
{
    ...
    public partial class Users
    {
        ...
        {
            if (uid > 0)
                return Lib.Data.Users.GetPartUserById(uid);
        ...
        {
            if (uid > 0)
                return Lib.Data.Users.GetUserById(uid);
        ...
        {
            if (uid > 0)
                return Lib.Data.Users.GetUserDetailById(uid);
        ...
        {
            return Lib.Data.Users.GetPartUserByName(userName);
        }
        ...
        {
            return Lib.Data.Users.GetPartUserByEmail(email);
        }
        ...
        {
            return Lib.Data.Users.GetPartUserByMobile(mobile);
        }
        ...
        public static int GetUidByUserName(string userName)
        {
            ...
            return Lib.Data.Users.GetUidByUserName(userName);
        }
        ...
        public static int GetUidByEmail(string email)
        {
            ...
            return Lib.Data.Users.GetUidByEmail(email);
        }
        ...
        public static int GetUidByMobile(string mobile)
        {
            ...
            return Lib.Data.Users.GetUidByMobile(mobile);
        }
        ...
        {
            return Lib.Data.Users.CreateUser(userInfo);
        }
        ...
        {
            Lib.Data.Users.UpdateUser(userInfo);
        }
        ...
        {
            Lib.Data.Users.UpdatePartUser(partUserInfo);
        }
        ...
        {
            Lib.Data.Users.UpdateUserDetail(userDetailInfo);
        }
        ...
        {
            Lib.Data.Users.UpdateUserLastVisit(uid, visitTime, ip, regionId);
        }
        ...
        {
            return Lib.Data.Users.GetUserCountByUserRid(userRid);
        }
        ...
        {
            return Lib.Data.Users.UpdateUser(uid, userName, nickName, avatar, gender, realName, bday, idCard, regionId, address, bio);
        }
        ...
        {
            Lib.Data.Users.UpdateUserEmailByUid(uid, email);
        }
        ...
        {
            Lib.Data.Users.UpdateUserMobileByUid(uid, mobile);
        }
        ...
        {
            Lib.Data.Users.UpdateUserPasswordByUid(uid, password);
        }
        ...
        {
            Lib.Data.Users.UpdateUserLiftBanTimeByUid(uid, liftBanTime);
        }
        ...
        {
            Lib.Data.Users.UpdateUserRankByUid(uid, userRid);
        }
        ...
        {
            int updateOnlineTimeSpan = MngConfig.SiteConfig.UpdateOnlineTimeSpan;
            ...
            {
                Lib.Data.Users.UpdateUserOnlineTime(uid, updateOnlineTimeSpan, DateTime.Now);
        ...
        {
            return Lib.Data.Users.GetRegisterTimeByRegisterIP(registerIP);
        }
        ...
        {
            return Lib.Data.Users.GetUserLastVisitTimeByUid(uid);
        }
    }
}
